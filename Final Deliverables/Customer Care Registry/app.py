...
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=764264db-9824-4b7c-82df-40d1b13897c2.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=32536;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=zjx00196;PWD=f8wBuCLcY3okJRdV",'','')
print(conn)
...
@app.route('/')
def home():
    message = "TEAM ID : PNT2022TMID53488" +" "+ "BATCH ID : B1-1M3E "
...
def register():
    flash("Record stored Successfully")
